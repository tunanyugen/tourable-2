...
class Menu extends GUIObject<MenuProps, MenuState> {
    constructor(props: MenuProps) {
        ...
        // rerender on new scenegroup creation
        this.props.tourable.sceneGroupObservable.Add(
    ...
    renderItem() {
        return Array.from(this.props.tourable.sceneGroups).map(([id, sceneGroup]) => {
            return (
                <MenuItem
                    tourable={this.props.tourable}
                    key={`${sceneGroup.id}-${sceneGroup.name}`}
            ...
            >
                ...
                <Slide in={this.state.show} direction="right" timeout={1000}>
                    ...
                    >
                        {/* Logo image */}
                        <img
                            src="https://www.greenfeed.com.vn/wp-content/uploads/2021/08/logo.svg"
                            alt="Logo Client"
                            style={{
                                display: "block",
                        ...
                        <List sx={{ padding: "0 calc(100vw * 32 / 1280)" }}>{this.renderItem()}</List>
                    </Box>
                </Slide>
            </Box>
        );
